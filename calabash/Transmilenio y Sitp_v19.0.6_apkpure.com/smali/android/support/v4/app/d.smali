...
.method public constructor <init>(Landroid/support/v4/app/c;)V
    ...
    .line 48
    iget-object v1, p1, Landroid/support/v4/app/c;->c:Ljava/util/ArrayList;
    ...
    .line 51
    iget-boolean v1, p1, Landroid/support/v4/app/c;->j:Z
    ...
    .line 57
    iget-object v0, p1, Landroid/support/v4/app/c;->c:Ljava/util/ArrayList;
    ...
    .line 63
    iget-object v5, p0, Landroid/support/v4/app/d;->a:[I
    ...
    .line 66
    iget v0, p1, Landroid/support/v4/app/c;->i:I

    iput v0, p0, Landroid/support/v4/app/d;->c:I

    .line 67
    iget-object v0, p1, Landroid/support/v4/app/c;->l:Ljava/lang/String;
    ...
    .line 71
    iget v0, p1, Landroid/support/v4/app/c;->q:I

    iput v0, p0, Landroid/support/v4/app/d;->h:I

    .line 72
    iget-object v0, p1, Landroid/support/v4/app/c;->r:Ljava/lang/CharSequence;
    ...
    .line 74
    iget-object v0, p1, Landroid/support/v4/app/c;->t:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/d;->k:Ljava/util/ArrayList;

    .line 75
    iget-boolean v0, p1, Landroid/support/v4/app/c;->u:Z
...
.method public a(Landroid/support/v4/app/n;)Landroid/support/v4/app/c;
    ...
    iput v0, v3, Landroid/support/v4/app/c;->i:I

    .line 122
    iget-object v0, p0, Landroid/support/v4/app/d;->d:Ljava/lang/String;

    iput-object v0, v3, Landroid/support/v4/app/c;->l:Ljava/lang/String;
    ...
    .line 124
    iput-boolean v7, v3, Landroid/support/v4/app/c;->j:Z

    .line 125
    iget v0, p0, Landroid/support/v4/app/d;->f:I

    iput v0, v3, Landroid/support/v4/app/c;->o:I

    .line 126
    iget-object v0, p0, Landroid/support/v4/app/d;->g:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/c;->p:Ljava/lang/CharSequence;

    .line 127
    iget v0, p0, Landroid/support/v4/app/d;->h:I

    iput v0, v3, Landroid/support/v4/app/c;->q:I

    .line 128
    iget-object v0, p0, Landroid/support/v4/app/d;->i:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/c;->r:Ljava/lang/CharSequence;

    .line 129
    iget-object v0, p0, Landroid/support/v4/app/d;->j:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/c;->s:Ljava/util/ArrayList;

    .line 130
    iget-object v0, p0, Landroid/support/v4/app/d;->k:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/c;->t:Ljava/util/ArrayList;

    .line 131
    iget-boolean v0, p0, Landroid/support/v4/app/d;->l:Z

    iput-boolean v0, v3, Landroid/support/v4/app/c;->u:Z
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 146
    iget-object v1, p0, Landroid/support/v4/app/d;->d:Ljava/lang/String;
