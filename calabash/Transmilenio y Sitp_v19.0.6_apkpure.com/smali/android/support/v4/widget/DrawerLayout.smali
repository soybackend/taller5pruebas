...
.field private final k:Landroid/support/v4/widget/n;

.field private final l:Landroid/support/v4/widget/n;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v6, v2}, Landroid/support/v4/widget/n;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/n$a;)Landroid/support/v4/widget/n;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/n;

    .line 318
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/n;

    invoke-virtual {v2, v5}, Landroid/support/v4/widget/n;->a(I)V

    .line 319
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/n;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/n;->a(F)V

    .line 320
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/DrawerLayout$f;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/n;

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/DrawerLayout$f;->a(Landroid/support/v4/widget/n;)V
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/n;

    .line 323
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/n;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/n;->a(I)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/widget/DrawerLayout$f;->a(Landroid/support/v4/widget/n;)V
    ...
    invoke-static {p0, v1}, Landroid/support/v4/view/s;->a(Landroid/view/View;Landroid/support/v4/view/b;)V

    .line 334
    invoke-static {p0, v7}, Landroid/support/v4/view/u;->a(Landroid/view/ViewGroup;Z)V

    .line 335
    invoke-static {p0}, Landroid/support/v4/view/s;->p(Landroid/view/View;)Z
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/n;

    .line 592
    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/widget/n;->e()V
    ...
    .line 591
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/n;
...
.method a(IILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/n;->a()I

    move-result v2

    .line 757
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/n;
...
.method public a(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, p1, v2, v1}, Landroid/support/v4/widget/n;->a(Landroid/view/View;II)Z
...
.method a(Z)V
    ...
    .line 1557
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/n;
    ...
    .line 1557
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/n;->a(Landroid/view/View;II)Z
    ...
    .line 1560
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/n;
    ...
    .line 1560
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/n;->a(Landroid/view/View;II)Z
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/s;->a(Landroid/view/View;Landroid/support/v4/view/b;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/n;->a(Z)Z

    move-result v0

    .line 1259
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/n;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/n;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/n;->b()I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Landroid/support/v4/widget/n;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/n;

    .line 1429
    invoke-virtual {v4, p1}, Landroid/support/v4/widget/n;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1440
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/n;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/n;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/n;->d(I)Z
...
.method protected onMeasure(II)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/s;->p(Landroid/view/View;)Z
    ...
    .line 1020
    invoke-static {v11}, Landroid/support/v4/view/s;->p(Landroid/view/View;)Z
    ...
    .line 1063
    invoke-static {v11}, Landroid/support/v4/view/s;->l(Landroid/view/View;)F
    ...
    invoke-static {v11, v2}, Landroid/support/v4/view/s;->a(Landroid/view/View;F)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput v0, v6, Landroid/support/v4/widget/DrawerLayout$e;->a:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1493
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/n;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/n;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroid/support/v4/widget/n;->d()I
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/s;->a(Landroid/view/View;F)V
