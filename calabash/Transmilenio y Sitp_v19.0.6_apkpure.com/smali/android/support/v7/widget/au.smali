...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/au;->a:Landroid/view/animation/LinearInterpolator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/au;->b:Landroid/view/animation/DecelerateInterpolator;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/au;->a(Landroid/util/DisplayMetrics;)F

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/au;->f:F
...
.method protected a(I)I
    ...
    .prologue
    .line 179
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/au;->b(I)I
...
.method public a(Landroid/view/View;I)I
    ...
    .prologue
    .line 302
    invoke-virtual {p0}, Landroid/support/v7/widget/au;->e()Landroid/support/v7/widget/RecyclerView$h;
    ...
    .line 312
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/au;->a(IIIII)I
...
.method protected a(IILandroid/support/v7/widget/RecyclerView$t;Landroid/support/v7/widget/RecyclerView$s$a;)V
    ...
    invoke-direct {p0, v0, p1}, Landroid/support/v7/widget/au;->a(II)I
    ...
    invoke-direct {p0, v0, p2}, Landroid/support/v7/widget/au;->a(II)I
    ...
    .line 140
    invoke-virtual {p0, p4}, Landroid/support/v7/widget/au;->a(Landroid/support/v7/widget/RecyclerView$s$a;)V
...
.method protected a(Landroid/support/v7/widget/RecyclerView$s$a;)V
    ...
    .line 232
    invoke-virtual {p0}, Landroid/support/v7/widget/au;->i()I

    move-result v0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/au;->c(I)Landroid/graphics/PointF;
    ...
    .line 239
    :cond_1
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/au;->a(Landroid/graphics/PointF;)V

    .line 240
    iput-object v0, p0, Landroid/support/v7/widget/au;->c:Landroid/graphics/PointF;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/au;->b(I)I

    move-result v0

    .line 248
    iget v1, p0, Landroid/support/v7/widget/au;->d:I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/au;->a:Landroid/view/animation/LinearInterpolator;
...
.method protected a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$t;Landroid/support/v7/widget/RecyclerView$s$a;)V
    ...
    .prologue
    .line 112
    invoke-virtual {p0}, Landroid/support/v7/widget/au;->c()I

    move-result v0

    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/au;->b(Landroid/view/View;I)I

    move-result v0

    .line 113
    invoke-virtual {p0}, Landroid/support/v7/widget/au;->d()I

    move-result v1

    invoke-virtual {p0, p1, v1}, Landroid/support/v7/widget/au;->a(Landroid/view/View;I)I
    ...
    .line 115
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/au;->a(I)I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/au;->b:Landroid/view/animation/DecelerateInterpolator;
...
.method protected b(I)I
    ...
    iget v1, p0, Landroid/support/v7/widget/au;->f:F
...
.method protected c()I
    ...
    .line 206
    iget-object v0, p0, Landroid/support/v7/widget/au;->c:Landroid/graphics/PointF;
