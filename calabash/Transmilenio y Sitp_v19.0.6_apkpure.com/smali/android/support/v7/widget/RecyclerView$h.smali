...
# instance fields
.field private final a:Landroid/support/v7/widget/bx$b;

.field private final b:Landroid/support/v7/widget/bx$b;
...
.field r:Landroid/support/v7/widget/bx;

.field s:Landroid/support/v7/widget/bx;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->a:Landroid/support/v7/widget/bx$b;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->b:Landroid/support/v7/widget/bx$b;

    .line 7091
    new-instance v0, Landroid/support/v7/widget/bx;

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$h;->a:Landroid/support/v7/widget/bx$b;

    invoke-direct {v0, v1}, Landroid/support/v7/widget/bx;-><init>(Landroid/support/v7/widget/bx$b;)V

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->r:Landroid/support/v7/widget/bx;

    .line 7092
    new-instance v0, Landroid/support/v7/widget/bx;

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$h;->b:Landroid/support/v7/widget/bx$b;

    invoke-direct {v0, v1}, Landroid/support/v7/widget/bx;-><init>(Landroid/support/v7/widget/bx$b;)V

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->s:Landroid/support/v7/widget/bx;
...
.method private a(Landroid/support/v7/widget/RecyclerView$o;ILandroid/view/View;)V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/by;

    invoke-virtual {v1, v0}, Landroid/support/v7/widget/by;->h(Landroid/support/v7/widget/RecyclerView$w;)V
...
.method private a(Landroid/view/View;IZ)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/by;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/by;->e(Landroid/support/v7/widget/RecyclerView$w;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/by;->f(Landroid/support/v7/widget/RecyclerView$w;)V
...
.method a(Landroid/support/v4/view/a/b;)V
    ...
    invoke-virtual {p0, v0, v1, p1}, Landroid/support/v7/widget/RecyclerView$h;->a(Landroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$t;Landroid/support/v4/view/a/b;)V
...
.method public a(Landroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$t;Landroid/support/v4/view/a/b;)V
    .locals 4
    ...
    .line 9750
    invoke-static {v0, v1, v2, v3}, Landroid/support/v4/view/a/b$k;->a(IIZI)Landroid/support/v4/view/a/b$k;
...
.method public a(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$i;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/by;->e(Landroid/support/v7/widget/RecyclerView$w;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/by;->f(Landroid/support/v7/widget/RecyclerView$w;)V
...
.method a(Landroid/view/View;Landroid/support/v4/view/a/b;)V
    ...
    invoke-virtual {p0, v0, v1, p1, p2}, Landroid/support/v7/widget/RecyclerView$h;->a(Landroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$t;Landroid/view/View;Landroid/support/v4/view/a/b;)V
...
.method public a(Landroid/view/View;ZZ)Z
    ...
    .line 9329
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$h;->r:Landroid/support/v7/widget/bx;

    invoke-virtual {v3, p1, v2}, Landroid/support/v7/widget/bx;->a(Landroid/view/View;I)Z

    move-result v3

    if-eqz v3, :cond_1

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$h;->s:Landroid/support/v7/widget/bx;
