...
.field private b:Landroid/support/v7/widget/bp;

.field private c:Landroid/support/v7/widget/bp;

.field private d:Landroid/support/v7/widget/bp;

.field private e:Landroid/support/v7/widget/bp;
...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/bp;
    .locals 3
    ...
    iput-boolean v2, v0, Landroid/support/v7/widget/bp;->d:Z

    .line 276
    iput-object v1, v0, Landroid/support/v7/widget/bp;->a:Landroid/content/res/ColorStateList;
...
.method private a(Landroid/content/Context;Landroid/support/v7/widget/br;)V
    .locals 3
    ...
    invoke-virtual {p2, v0, v1}, Landroid/support/v7/widget/br;->a(II)I
    ...
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/br;->g(I)Z
    ...
    invoke-virtual {p2, v0, v1, v2}, Landroid/support/v7/widget/br;->a(IILandroid/widget/TextView;)Landroid/graphics/Typeface;
    ...
    .line 215
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/br;->d(I)Ljava/lang/String;
...
.method a()V
    ...
    .prologue
    .line 254
    iget-object v0, p0, Landroid/support/v7/widget/y;->b:Landroid/support/v7/widget/bp;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->c:Landroid/support/v7/widget/bp;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/bp;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->e:Landroid/support/v7/widget/bp;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/y;->b:Landroid/support/v7/widget/bp;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/y;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bp;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/y;->c:Landroid/support/v7/widget/bp;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/bp;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/y;->e:Landroid/support/v7/widget/bp;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/y;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bp;)V
...
.method a(Landroid/content/Context;I)V
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/br;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/br;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/br;->g(I)Z
    ...
    .line 236
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/br;->e(I)Landroid/content/res/ColorStateList;
    ...
    .line 242
    :cond_1
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/y;->a(Landroid/content/Context;Landroid/support/v7/widget/br;)V
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bp;)V
    .locals 1
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/m;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bp;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v7, p1, v3, p2, v2}, Landroid/support/v7/widget/br;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/br;
    ...
    invoke-virtual {v3, v4, v9}, Landroid/support/v7/widget/br;->g(II)I
    ...
    invoke-virtual {v3, v6}, Landroid/support/v7/widget/br;->g(I)Z
    ...
    .line 75
    invoke-virtual {v3, v6, v2}, Landroid/support/v7/widget/br;->g(II)I

    move-result v6

    .line 74
    invoke-static {v7, v0, v6}, Landroid/support/v7/widget/y;->a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/bp;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/y;->b:Landroid/support/v7/widget/bp;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/y;->c:Landroid/support/v7/widget/bp;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/bp;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/y;->e:Landroid/support/v7/widget/bp;

    .line 89
    :cond_3
    invoke-virtual {v3}, Landroid/support/v7/widget/br;->a()V
    ...
    invoke-static {v7, v4, v0}, Landroid/support/v7/widget/br;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/br;
    ...
    invoke-virtual {v9, v0}, Landroid/support/v7/widget/br;->g(I)Z
    ...
    invoke-virtual {v9, v0, v2}, Landroid/support/v7/widget/br;->a(IZ)Z
    ...
    .line 110
    :goto_0
    invoke-direct {p0, v7, v9}, Landroid/support/v7/widget/y;->a(Landroid/content/Context;Landroid/support/v7/widget/br;)V
    ...
    invoke-virtual {v9, v4}, Landroid/support/v7/widget/br;->g(I)Z
    ...
    invoke-virtual {v9, v4}, Landroid/support/v7/widget/br;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v9, v6}, Landroid/support/v7/widget/br;->g(I)Z
    ...
    invoke-virtual {v9, v6}, Landroid/support/v7/widget/br;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v9, v10}, Landroid/support/v7/widget/br;->g(I)Z
    ...
    invoke-virtual {v9, v5}, Landroid/support/v7/widget/br;->e(I)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    :goto_3
    invoke-virtual {v9}, Landroid/support/v7/widget/br;->a()V

    .line 130
    :goto_4
    sget-object v9, Landroid/support/v7/a/a$j;->TextAppearance:[I

    invoke-static {v7, p1, v9, p2, v2}, Landroid/support/v7/widget/br;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/br;
    ...
    invoke-virtual {v9, v1}, Landroid/support/v7/widget/br;->g(I)Z
    ...
    invoke-virtual {v9, v1}, Landroid/support/v7/widget/br;->e(I)Landroid/content/res/ColorStateList;
