...
.method private j(Landroid/support/v7/widget/af;)Landroid/support/v7/widget/be;
    .locals 1
...
.method public a(Landroid/support/v7/widget/af;)F
    ...
    .prologue
    .line 57
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ad;->j(Landroid/support/v7/widget/af;)Landroid/support/v7/widget/be;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/v7/widget/be;->a()F
...
.method public a(Landroid/support/v7/widget/af;F)V
    ...
    invoke-virtual {v0, p2}, Landroid/support/v7/widget/be;->a(F)V
...
.method public a(Landroid/support/v7/widget/af;Landroid/content/Context;Landroid/content/res/ColorStateList;FFF)V
    ...
    invoke-direct {v0, p3, p4}, Landroid/support/v7/widget/be;-><init>(Landroid/content/res/ColorStateList;F)V
...
.method public b(Landroid/support/v7/widget/af;F)V
    ...
    .line 50
    invoke-virtual {v0, p2, v1, v2}, Landroid/support/v7/widget/be;->a(FZZ)V
...
.method public d(Landroid/support/v7/widget/af;)F
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/be;->b()F
...
.method public f(Landroid/support/v7/widget/af;)V
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/bf;->b(FFZ)F
    ...
    invoke-static {v0, v1, v3}, Landroid/support/v7/widget/bf;->a(FFZ)F
...
.method public i(Landroid/support/v7/widget/af;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/be;->c()Landroid/content/res/ColorStateList;
