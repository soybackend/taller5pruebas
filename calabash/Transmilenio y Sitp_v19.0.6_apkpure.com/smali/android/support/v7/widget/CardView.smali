...
.field private static final f:Landroid/support/v7/widget/ag;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/CardView;->f:Landroid/support/v7/widget/ag;

    .line 89
    :goto_0
    sget-object v0, Landroid/support/v7/widget/CardView;->f:Landroid/support/v7/widget/ag;

    invoke-interface {v0}, Landroid/support/v7/widget/ag;->a()V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/CardView;->i:Landroid/support/v7/widget/af;
...
.method private a(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/CardView;->i:Landroid/support/v7/widget/af;

    move-object v2, p1

    invoke-interface/range {v0 .. v6}, Landroid/support/v7/widget/ag;->a(Landroid/support/v7/widget/af;Landroid/content/Context;Landroid/content/res/ColorStateList;FFF)V
...
.method public getCardBackgroundColor()Landroid/content/res/ColorStateList;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/ag;->i(Landroid/support/v7/widget/af;)Landroid/content/res/ColorStateList;
...
.method public getCardElevation()F
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/ag;->e(Landroid/support/v7/widget/af;)F
...
.method public getMaxCardElevation()F
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/ag;->a(Landroid/support/v7/widget/af;)F
...
.method public getRadius()F
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/ag;->d(Landroid/support/v7/widget/af;)F
...
.method protected onMeasure(II)V
    ...
    .line 195
    :sswitch_0
    sget-object v1, Landroid/support/v7/widget/CardView;->f:Landroid/support/v7/widget/ag;

    iget-object v2, p0, Landroid/support/v7/widget/CardView;->i:Landroid/support/v7/widget/af;

    invoke-interface {v1, v2}, Landroid/support/v7/widget/ag;->b(Landroid/support/v7/widget/af;)F
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/ag;->c(Landroid/support/v7/widget/af;)F
...
.method public setCardBackgroundColor(I)V
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v7/widget/ag;->a(Landroid/support/v7/widget/af;Landroid/content/res/ColorStateList;)V
...
.method public setCardBackgroundColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-interface {v0, v1, p1}, Landroid/support/v7/widget/ag;->a(Landroid/support/v7/widget/af;Landroid/content/res/ColorStateList;)V
...
.method public setCardElevation(F)V
    ...
    invoke-interface {v0, v1, p1}, Landroid/support/v7/widget/ag;->c(Landroid/support/v7/widget/af;F)V
...
.method public setMaxCardElevation(F)V
    ...
    invoke-interface {v0, v1, p1}, Landroid/support/v7/widget/ag;->b(Landroid/support/v7/widget/af;F)V
...
.method public setPreventCornerOverlap(Z)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/ag;->h(Landroid/support/v7/widget/af;)V
...
.method public setRadius(F)V
    ...
    invoke-interface {v0, v1, p1}, Landroid/support/v7/widget/ag;->a(Landroid/support/v7/widget/af;F)V
...
.method public setUseCompatPadding(Z)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/ag;->g(Landroid/support/v7/widget/af;)V
