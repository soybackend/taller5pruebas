...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p1, p2, v0, p3, v7}, Landroid/support/v7/widget/br;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/br;
    ...
    invoke-static {v2, p2, v5, p3, v7}, Landroid/support/v7/widget/br;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/br;
    ...
    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/br;->f(II)I
    ...
    .line 246
    invoke-virtual {v2, v5}, Landroid/support/v7/widget/br;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/br;->d(I)Ljava/lang/String;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/x;->d:Landroid/support/v7/widget/aq;

    .line 268
    :cond_2
    sget v0, Landroid/support/v7/a/a$j;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/br;->f(I)[Ljava/lang/CharSequence;
    ...
    .line 276
    :cond_3
    invoke-virtual {v4}, Landroid/support/v7/widget/br;->a()V
    ...
    invoke-virtual {v4, v0, v7}, Landroid/support/v7/widget/br;->g(II)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 418
    iget-object v0, p0, Landroid/support/v7/widget/x;->d:Landroid/support/v7/widget/aq;
