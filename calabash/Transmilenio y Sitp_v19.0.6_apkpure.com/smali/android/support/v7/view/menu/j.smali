...
.method public b()Z
    ...
    .line 189
    :cond_3
    iget-object v1, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/view/c;

    if-eqz v1, :cond_4

    iget-object v1, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/view/c;

    invoke-virtual {v1}, Landroid/support/v4/view/c;->d()Z
...
.method public isVisible()Z
    ...
    .line 626
    iget-object v2, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/view/c;

    if-eqz v2, :cond_2

    iget-object v2, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/view/c;

    invoke-virtual {v2}, Landroid/support/v4/view/c;->b()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/c;->c()Z
...
.method public n()Z
    ...
    invoke-virtual {v1, p0}, Landroid/support/v4/view/c;->a(Landroid/view/MenuItem;)Landroid/view/View;
