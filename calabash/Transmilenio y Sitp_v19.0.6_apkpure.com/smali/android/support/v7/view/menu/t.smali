...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/h;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/ay;
...
.method private j()Z
    ...
    .line 154
    iget-object v0, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/ay;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ay;->g(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ay;->a(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ay;->g()Landroid/widget/ListView;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ay;->a(Landroid/widget/ListAdapter;)V
...
.method public a(Landroid/support/v7/view/menu/u;)Z
    ...
    .line 273
    iget-object v1, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/ay;

    invoke-virtual {v1}, Landroid/support/v7/widget/ay;->j()I

    move-result v1

    .line 274
    iget-object v2, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/ay;

    invoke-virtual {v2}, Landroid/support/v7/widget/ay;->k()I
