...
.field private final p:Landroid/support/design/widget/o;
...
.method constructor <init>(Landroid/support/design/widget/x;Landroid/support/design/widget/m;)V
    .locals 3
    ...
    iput-object v0, p0, Landroid/support/design/widget/h;->r:Landroid/graphics/Rect;

    .line 90
    iput-object p1, p0, Landroid/support/design/widget/h;->n:Landroid/support/design/widget/x;

    .line 91
    iput-object p2, p0, Landroid/support/design/widget/h;->o:Landroid/support/design/widget/m;
    ...
    iput-object v0, p0, Landroid/support/design/widget/h;->p:Landroid/support/design/widget/o;

    .line 96
    iget-object v0, p0, Landroid/support/design/widget/h;->p:Landroid/support/design/widget/o;
    ...
    .line 107
    iget-object v0, p0, Landroid/support/design/widget/h;->n:Landroid/support/design/widget/x;
...
.method private o()V
    ...
    .prologue
    .line 371
    iget-object v0, p0, Landroid/support/design/widget/h;->s:Landroid/view/ViewTreeObserver$OnPreDrawListener;
    ...
    iput-object v0, p0, Landroid/support/design/widget/h;->s:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method private q()V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/design/widget/x;->setLayerType(ILandroid/graphics/Paint;)V
    ...
    invoke-virtual {v0, v1, v3}, Landroid/support/design/widget/x;->setLayerType(ILandroid/graphics/Paint;)V
...
.method a(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/c;
    ...
    .line 350
    invoke-static {v0, v3}, Landroid/support/v4/a/b;->c(Landroid/content/Context;I)I
    ...
    .line 351
    invoke-static {v0, v4}, Landroid/support/v4/a/b;->c(Landroid/content/Context;I)I
    ...
    .line 352
    invoke-static {v0, v5}, Landroid/support/v4/a/b;->c(Landroid/content/Context;I)I
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/h;->n:Landroid/support/design/widget/x;
    ...
    iget-object v3, p0, Landroid/support/design/widget/h;->o:Landroid/support/design/widget/m;
    ...
    iput-object v0, p0, Landroid/support/design/widget/h;->c:Landroid/support/design/widget/l;
    ...
    iget-object v1, p0, Landroid/support/design/widget/h;->c:Landroid/support/design/widget/l;
...
.method b(Landroid/support/design/widget/h$c;Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/x;->setAlpha(F)V

    .line 271
    iget-object v0, p0, Landroid/support/design/widget/h;->n:Landroid/support/design/widget/x;

    invoke-virtual {v0, v1}, Landroid/support/design/widget/x;->setScaleY(F)V

    .line 272
    iget-object v0, p0, Landroid/support/design/widget/h;->n:Landroid/support/design/widget/x;

    invoke-virtual {v0, v1}, Landroid/support/design/widget/x;->setScaleX(F)V
...
.method final e()V
    ...
    .prologue
    .line 315
    iget-object v0, p0, Landroid/support/design/widget/h;->r:Landroid/graphics/Rect;
    ...
    .line 318
    iget-object v1, p0, Landroid/support/design/widget/h;->o:Landroid/support/design/widget/m;
...
.method f()V
    ...
    iget-object v1, p0, Landroid/support/design/widget/h;->s:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method m()Z
    ...
    .line 394
    iget-object v2, p0, Landroid/support/design/widget/h;->n:Landroid/support/design/widget/x;

    invoke-virtual {v2}, Landroid/support/design/widget/x;->getVisibility()I
    ...
    .line 396
    iget v2, p0, Landroid/support/design/widget/h;->b:I
