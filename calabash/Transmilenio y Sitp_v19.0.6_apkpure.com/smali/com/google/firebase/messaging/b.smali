...
.method private final a(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/Integer;Landroid/net/Uri;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    invoke-static {v0}, Lcom/google/firebase/messaging/b;->a(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private final b(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-static {v2, v1}, Landroid/support/v4/a/b;->c(Landroid/content/Context;I)I
...
.method private final c(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget v7, Lcom/google/android/gms/a$c;->fcm_fallback_notification_channel_label:I
...
.method private final e(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    iget-object v2, p0, Lcom/google/firebase/messaging/b;->f:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method final c(Landroid/os/Bundle;)Z
    ...
    invoke-static {v0, v7, v6, v12}, Lcom/google/firebase/iid/y;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {v7, v8, v0, v12}, Lcom/google/firebase/iid/y;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/b;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v9}, Landroid/support/v4/app/aa$c;->b(Z)Landroid/support/v4/app/aa$c;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/aa$c;->a(Landroid/support/v4/app/aa$m;)Landroid/support/v4/app/aa$c;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/aa$c;->c(I)Landroid/support/v4/app/aa$c;

    :cond_16
    if-eqz v5, :cond_17

    invoke-virtual {v0, v5}, Landroid/support/v4/app/aa$c;->a(Landroid/net/Uri;)Landroid/support/v4/app/aa$c;

    :cond_17
    if-eqz v6, :cond_18

    invoke-virtual {v0, v6}, Landroid/support/v4/app/aa$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/aa$c;

    :cond_18
    if-eqz v7, :cond_19

    invoke-virtual {v0, v7}, Landroid/support/v4/app/aa$c;->b(Landroid/app/PendingIntent;)Landroid/support/v4/app/aa$c;
