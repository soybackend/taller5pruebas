...
.method public static a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/internal/bl;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method static a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bm;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    :cond_2
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/bl;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/bl;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/bl;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Lcom/google/android/gms/common/api/internal/ay;)Lcom/google/android/gms/common/api/internal/ax;
    .locals 2
    ...
    invoke-direct {v0, p1}, Lcom/google/android/gms/common/api/internal/ax;-><init>(Lcom/google/android/gms/common/api/internal/ay;)V

    invoke-virtual {p0, v0, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-virtual {v0, p0}, Lcom/google/android/gms/common/api/internal/ax;->a(Landroid/content/Context;)V

    const-string v1, "com.google.android.gms"

    invoke-static {p0, v1}, Lcom/google/android/gms/common/s;->zzv(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private final a(Landroid/content/Context;Landroid/app/NotificationManager;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/google/android/gms/common/internal/bl;->a(Landroid/content/Context;)Ljava/lang/String;
...
.method static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {v1, v0, p2}, Lcom/google/android/gms/common/d;->a(Landroid/support/v4/app/m;Ljava/lang/String;)V
...
.method private final a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/bl;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v1

    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/bl;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/google/android/gms/common/internal/aj;->a(Z)V
    ...
    invoke-direct {v4, p1}, Landroid/support/v4/app/aa$c;-><init>(Landroid/content/Context;)V

    const v5, 0x108008a

    invoke-virtual {v4, v5}, Landroid/support/v4/app/aa$c;->a(I)Landroid/support/v4/app/aa$c;

    move-result-object v4

    sget v5, Lcom/google/android/gms/a$c;->common_google_play_services_notification_ticker:I

    invoke-virtual {v3, v5}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v4, v3}, Landroid/support/v4/app/aa$c;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/aa$c;
    ...
    invoke-virtual {v3, v4, v5}, Landroid/support/v4/app/aa$c;->a(J)Landroid/support/v4/app/aa$c;

    move-result-object v3

    invoke-virtual {v3, v6}, Landroid/support/v4/app/aa$c;->b(Z)Landroid/support/v4/app/aa$c;

    move-result-object v3

    invoke-virtual {v3, p4}, Landroid/support/v4/app/aa$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/aa$c;
    ...
    invoke-virtual {v1, v6}, Landroid/support/v4/app/aa$c;->c(Z)Landroid/support/v4/app/aa$c;
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/app/aa$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/aa$b;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroid/support/v4/app/aa$c;->a(Landroid/support/v4/app/aa$m;)Landroid/support/v4/app/aa$c;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/app/aa$c;->a(Ljava/lang/String;)Landroid/support/v4/app/aa$c;
    ...
    sget-object v3, Lcom/google/android/gms/common/s;->zzfln:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private final c()Ljava/lang/String;
    ...
    sget-object v1, Lcom/google/android/gms/common/c;->c:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/common/c;->e:Ljava/lang/String;
...
.method public a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0, p3}, Lcom/google/android/gms/common/internal/bm;->a(Landroid/app/Activity;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/bm;

    move-result-object v0

    invoke-static {p1, p2, v0, p4}, Lcom/google/android/gms/common/c;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bm;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/common/a;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, v0, v1}, Lcom/google/android/gms/common/i;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public final a(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/be;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 2
    ...
    invoke-static {p2, v0, v1}, Lcom/google/android/gms/common/internal/bm;->a(Lcom/google/android/gms/common/api/internal/be;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/bm;

    move-result-object v0

    invoke-static {p1, p3, v0, p5}, Lcom/google/android/gms/common/c;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bm;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
